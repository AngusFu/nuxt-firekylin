...
export default {
  ...
  methods: {
    onKeydown(e) {
      ...
      const n = +e.keyCode;
      const { prev, next } = this.post;
      const item = n === 37 ? prev : n === 39 ? next : null;
